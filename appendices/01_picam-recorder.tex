...
\lstinputlisting[language=Python, caption={The Python code for the `app.py' entry point to the Lossless Raspberry Pi Camera Recorder, commit version: \texttt{30efb5a} from \cite{sidharthshanmugamPicamvideorecorder2024}.}]{code/01_picam-recorder/app.py}


\subsubsection{ProjectorManger: `ProjectorManager.py'}

\lstinputlisting[language=Python, caption={The Python code for `ProjectorManager.py' in the Lossless Raspberry Pi Camera Recorder, commit version: \texttt{30efb5a} from \cite{sidharthshanmugamPicamvideorecorder2024}.}]{code/01_picam-recorder/ProjectorManager.py}


\subsubsection{CameraManager: `CameraManager.py'}

\lstinputlisting[language=Python, caption={The Python code for `CameraManager.py' in the Lossless Raspberry Pi Camera Recorder, commit version: \texttt{30efb5a} from \cite{sidharthshanmugamPicamvideorecorder2024}.}]{code/01_picam-recorder/CameraManager.py}


\subsubsection{PreviewManager: `PreviewManager.py'}

\lstinputlisting[language=Python, caption={The Python code for `PreviewManager.py' in the Lossless Raspberry Pi Camera Recorder, commit version: \texttt{30efb5a} from \cite{sidharthshanmugamPicamvideorecorder2024}.}]{code/01_picam-recorder/PreviewManager.py}
